...
#define MOT1_Imes_Pin GPIO_PIN_3
#define MOT1_Imes_GPIO_Port GPIOA
#define MOT2_FW_Pin GPIO_PIN_6
#define MOT2_FW_GPIO_Port GPIOA
...
#define MOT2_REV_Pin GPIO_PIN_1
